...
namespace BookStore.API.Tests
{
    public class BooksControllerTests
    {
        ...
        public BooksControllerTests()
        {
            ...
            _booksController =
                new BooksController(_mapperMock.Object, _bookServiceMock.Object, _authorServiceMock.Object);
        }
        ...
        public async void GetBooksByCategory_ShouldReturnOk_WhenBookWithSearchedCategoryExist()
        {
            ...
            _mapperMock.Setup(m => m.Map<IEnumerable<BookResultDto>>(It.IsAny<IEnumerable<Book>>()))
                .Returns(dtoExpected);
