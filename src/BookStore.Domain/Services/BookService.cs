    ...
    public class BookService : IBookService
    {
        ...
        public async Task<Book> Update(Book book)
        {
            if (_bookRepository.Search(b => b.Name == book.Name && b.Id != book.Id).Result.Any())
                return null;
            book.ModifiedDateTime = DateTime.UtcNow;
        ...
        {
            return await _bookRepository.GetBooksByAuthors(authorId);
        }
        ...
        public async Task<IEnumerable<Book>> SearchBookWithAuthor(string searchedValue)
        {
            return await _bookRepository.SearchBookWithAuthors(searchedValue);
        }
