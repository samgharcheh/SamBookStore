...
namespace BookStore.API.Controllers
{
    ...
    public class BooksController : MainController
    {
        ...
        public BooksController(IMapper mapper, IBookService bookService, IAuthorService authorService)
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> Add(BookAddDto bookDto)
        {
            ...
            var bookAuthors = await _authorService.GetByIds(bookDto.AuthorIds);
